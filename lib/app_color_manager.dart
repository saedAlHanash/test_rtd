...
class AppColorManager {
  ...
  static const mainColorLight = Color(0xFF927AE8);
...
//#FDBCAB
//#58E4D6
Color getCardColor(int i) {
  if ((i + 1) % 4 == 0) return const Color(0xFF58E4D6);
  if ((i + 1) % 3 == 0) return const Color(0xFFFDBCAB);
  if ((i + 1) % 2 == 0) return const Color(0xFFFF99F2);
  return const Color(0xFFC1B3F1);
}
